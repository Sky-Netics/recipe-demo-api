...
recipe_input = api.model('RecipeInput', {
    ...
    'ingredients': fields.List(fields.String, required=True, description='List of recipe ingredients'),
    'procedure': fields.List(fields.String, required=True, description='List of cooking procedure steps'),
...
recipe_output = api.model('Recipe', {
    ...
    'ingredients': fields.List(fields.String, description='List of recipe ingredients'),
    'procedure': fields.List(fields.String, description='List of cooking procedure steps'),
